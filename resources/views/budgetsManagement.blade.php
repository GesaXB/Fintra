    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="text-2xl font-bold text-gray-900 mb-1">Rp 8.500.000</div>
                <div class="text-sm text-emerald-600">+12% from last month</div>
            </div>

            <!-- Used Budget -->
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide">Used Budget</h3>
                ...
                <div class="text-2xl font-bold text-gray-900 mb-1">Rp 5.200.000</div>
                <div class="text-sm text-red-600">61% of total budget</div>
            </div>

            <!-- Remaining Budget -->
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide">Remaining Budget</h3>
                ...
                <div class="text-2xl font-bold text-emerald-600 mb-1">Rp 3.300.000</div>
                <div class="text-sm text-emerald-600">39% remaining</div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-8">
            ...
            <div class="flex flex-wrap gap-3">
                <button id="createBudgetBtn" class="bg-emerald-500 text-white px-6 py-3 rounded-xl font-medium hover:bg-emerald-600 transition-colors flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
                    <span>Create Budget</span>
                </button>
                <button class="bg-blue-500 text-white px-6 py-3 rounded-xl font-medium hover:bg-blue-600 transition-colors flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                    </svg>
                    <span>Edit Budget</span>
                </button>
                <button class="bg-gray-100 text-gray-700 px-6 py-3 rounded-xl font-medium hover:bg-gray-200 transition-colors flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900">Budget Categories</h3>
                        <button class="text-emerald-600 hover:text-emerald-700 font-medium text-sm">View All</button>
                    </div>
                </div>
                <div class="p-6">
                    <div class="space-y-6">
            ...
            <!-- Modal Create Budget -->
        <div id="budgetModal" class="fixed inset-0 bg-black bg-opacity-40 hidden items-center justify-center z-50">
            <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
                <h2 class="text-lg font-semibold mb-4">Create New Budget</h2>
                <form id="budgetForm">
                    <div class="mb-4">
                        <label class="block text-sm font-medium">Description</label>
                        <input type="text" id="description" class="w-full px-4 py-2 border rounded-md" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium">Amount</label>
                        <input type="number" id="amount" class="w-full px-4 py-2 border rounded-md" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium">Start Date</label>
                        <input type="date" id="start_date" class="w-full px-4 py-2 border rounded-md" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium">End Date</label>
                        <input type="date" id="end_date" class="w-full px-4 py-2 border rounded-md" required>
                    </div>
                    <div class="flex justify-end space-x-3">
                        <button type="button" id="cancelModal" class="text-gray-500 hover:underline">Cancel</button>
                        <button type="submit" class="bg-emerald-500 text-white px-4 py-2 rounded-md hover:bg-emerald-600">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="mt-8 bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-900">Recent Budget Activities</h3>
                    <button class="text-emerald-600 hover:text-emerald-700 font-medium text-sm">View All</button>
                </div>
            </div>
            <div class="p-6">
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 mb-6">Start managing your budgets to see activities here</p>
                    <button class="bg-emerald-500 text-white px-6 py-3 rounded-xl font-medium hover:bg-emerald-600 transition-colors">
...
<script>
    ...
    document.getElementById('userName').textContent = 'Hello, ' + '{{ Auth::user()->name }}';
    document.getElementById('dropdownUserName').textContent = '{{ Auth::user()->name }}';
